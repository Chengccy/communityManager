...
public class DepartmentDaoImpl implements DepartmentDao {
    ...
    public List<DepartmentPOVO> getDepartment(Integer companyId) {
        ...
        String sql="";
        if(companyId==-1){
             sql="select a.*,b.company_name from department_t a,company_t b where a.company_id=b.company_id";
        }else{
            sql="select a.*,b.company_name from department_t a,company_t b where a.company_id=b.company_id and a.company_id="+companyId;
        }
        Connection connection = JDBCUtil.getConnection();
        PreparedStatement preparedStatement = null;
        ResultSet resultSet = null;
        try {
            ...
            while (resultSet.next()){
                ...
                departmentPOVO.setStatus(resultSet.getInt(3));
                departmentPOVO.setCompanyId(resultSet.getInt(4));
    ...
    public List<StaffCount> getStaffCount(Integer companyId, Integer departmentId) {
        ...
        if(departmentId==-1){
            if(companyId==-1){
                sql="select a.company_name,b.department_name,count(*) from company_t a,department_t b,user_t c " +
                        "where a.company_id=b.company_id and b.department_id=c.department_id group by a.company_name,b.department_name order by a.company_name";
            }else{
                sql="select a.company_name,b.department_name,count(*) from company_t a,department_t b,user_t c " +
                        "where a.company_id=b.company_id and b.department_id=c.department_id and a.company_id="+companyId+" group by a.company_name,b.department_name order by a.company_name";
            }

        }else{
            sql="select a.company_name,b.department_name,count(*) from company_t a,department_t b,user_t c " +
                    "where a.company_id=b.company_id and b.department_id=c.department_id and a.company_id="+companyId+" and b.department_id="+departmentId+" group by a.company_name,b.department_name order by a.company_name";
        }
        PreparedStatement preparedStatement=null;
        ResultSet resultSet=null;
        try {
